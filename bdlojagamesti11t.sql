...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30-Set-2021 às 19:16
...
CREATE TABLE `tbjogos` (
  ...
  `consoleJog` varchar(20) NOT NULL,
  `classificacaoJog` int(6) NOT NULL,
...
(1, 'Fortinite', '45Kb', '5.99', 'Ram 3 g, Hd 1Terra', 'pc', 16, 0),
(2, 'Call of Duty Black Ops 2', '16 GB', '79.00', 'Processador: Intel Core 2 Duo E8200 2.66 GHz ou AMD Phenom X3 8750 2.4 GHz. Memória RAM: 2 GB para sistemas 32-bits ou 4 GB para sistemas 64-bits. Placa de vídeo: NVIDIA GeForce 8800GT 512 MB ou ATI R', 'PC/XBOX/Plastation e', 18, 0),
(3, 'mario', '12', '3.00', 'pc', 'pc', 5, 5),
(4, 'Tibia', '20GB', '20.00', '8Ram I5', 'PC', 5, 5);
